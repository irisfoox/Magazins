...
import img1 from '../img/adjust-solid.png'
...
<div className="body">
        ...
        <div className="col-10 logo mb-3">
           ...
           {/* <div type="button" className="btn btn-primary mt-auto p-2">category</div> */}<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
           <div className="mt-auto p-2"><button className="b1"><b>Category</b></button></div>
           {/* btn btn-primary b1 */}
           </div>
           </div>
        </div>
